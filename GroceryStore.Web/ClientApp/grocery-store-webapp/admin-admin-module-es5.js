...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["admin-admin-module"], {
  ...
  /***/
  function srcAppAdminAddOrEditCategoryAddOrEditCategoryComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AddOrEditCategoryComponent", function () {
      return AddOrEditCategoryComponent;
    });
    /* harmony import */
    ...
    var src_app_shared_validators_generic_validator_messages__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    var AddOrEditCategoryComponent = /*#__PURE__*/function () {
      function AddOrEditCategoryComponent(fb, router, activatedRoute, categoryService) {
        _classCallCheck(this, AddOrEditCategoryComponent);
      ...
      _createClass(AddOrEditCategoryComponent, [{
        key: "ngOnInit",
        ...
        value: function ngAfterViewInit() {
          ...
          var controlBlurs = this.formInputElements.map(function (formControl) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["fromEvent"])(formControl.nativeElement, 'blur');
          }); // Merge the blur event observable with the valueChanges observable
          // so we only need to subscribe once.

          Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["merge"]).apply(void 0, [this.addOREditCategoryForm.valueChanges].concat(_toConsumableArray(controlBlurs))).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["debounceTime"])(1000)).subscribe(function (value) {
            _this2.displayMessage = _this2.genericValidator.processMessages(_this2.addOREditCategoryForm);
          });
        }
      }, {
        key: "initForm",
        value: function initForm() {
          ...
          if (this.editMode) {
            ...
            this.categoryService.getCategoryById(this.id).subscribe({
              next: function next(category) {
                _this3.category = category;
                _this3.title = "Edit Category: ".concat(_this3.category.name); //lama 3mlt new formGroup brdo gab nafs error wtf!
                // this.addOREditCategoryForm = new FormGroup({
                //   name:new FormControl(this.category.name)
                // });

                _this3.addOREditCategoryForm = _this3.fb.group({
                  name: [_this3.category.name, [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].minLength(3)]]
                });
              }
            });
          } else {
        ...
        value: function saveCategory() {
          ...
          if (this.addOREditCategoryForm.valid) {
            if (this.addOREditCategoryForm.dirty) {
              var category = Object.assign(Object.assign({}, this.category), this.addOREditCategoryForm.value);

              if (!this.editMode) {
                this.categoryService.addCategory(category).subscribe({
                  next: function next() {
                    _this4.addOREditCategoryForm.reset();
    ...
    AddOrEditCategoryComponent.ɵfac = function AddOrEditCategoryComponent_Factory(t) {
      return new (t || AddOrEditCategoryComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_5__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_category_service__WEBPACK_IMPORTED_MODULE_6__["CategoryService"]));
    };

    AddOrEditCategoryComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: AddOrEditCategoryComponent,
      selectors: [["app-add-or-edit-category"]],
      viewQuery: function AddOrEditCategoryComponent_Query(rf, ctx) {
        if (rf & 1) {
      ...
      decls: 19,
      vars: 9,
      consts: [[1, "container"], [1, "card"], [1, "card-header"], [1, "card-body"], ["novalidate", "", "autocomplete", "off", 3, "formGroup", "ngSubmit"], [1, "form-group", "row"], ["for", "productNameId", 1, "col-md-2", "col-form-label"], [1, "col-md-8"], ["id", "productNameId", "type", "text", "placeholder", "Name (required)", "formControlName", "name", 1, "form-control"], [1, "invalid-feedback"], [1, "row"], [1, "col-md-4", "offset-md-2"], ["type", "submit", 1, "btn", "bg-green-light", "text-white", "mr-4", 3, "disabled", "title"], [1, "btn", "btn-outline-secondary", 3, "click"]],
      template: function AddOrEditCategoryComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function AddOrEditCategoryComponent_Template_form_ngSubmit_5_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AddOrEditCategoryComponent_Template_button_click_17_listener() {
            return ctx.onCancel();
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AddOrEditCategoryComponent, [{
  ...
  /***/
  function srcAppAdminAddOrEditProductAddOrEditProductComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AddOrEditProductComponent", function () {
      return AddOrEditProductComponent;
    });
    /* harmony import */
    ...
    var AddOrEditProductComponent = /*#__PURE__*/function () {
      function AddOrEditProductComponent(fb, router, activatedRoute, productService) {
        _classCallCheck(this, AddOrEditProductComponent);
      ...
      _createClass(AddOrEditProductComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this5 = this;
          ...
          this.subscription = this.activatedRoute.params.subscribe(function (params) {
            _this5.id = +params['id'];
            _this5.editMode = params['id'] != null;
        ...
        value: function ngAfterViewInit() {
          ...
          Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["merge"]).apply(void 0, [this.addOREditProductForm.valueChanges].concat(_toConsumableArray(controlBlurs))).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["debounceTime"])(1000)).subscribe(function (value) {
            _this6.displayMessage = _this6.genericValidator.processMessages(_this6.addOREditProductForm);
          });
        }
      }, {
        key: "initForm",
          ...
          if (this.editMode) {
            ...
            this.productService.getProductById(this.id).subscribe({
              next: function next(product) {
                _this7.product = product;
                _this7.title = "Edit Product: ".concat(_this7.product.name); //lama 3mlt new formGroup brdo gab nafs error wtf!
                // this.addOREditCategoryForm = new FormGroup({
                //   name:new FormControl(this.category.name)
                // });

                _this7.addOREditProductForm = _this7.fb.group({
                  name: [_this7.product.name, [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].minLength(3)]],
                  price: [_this7.product.price, [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required]],
                  description: [_this7.product.description],
                  categoryName: [_this7.product.categoryName]
                });
              }
            });
          } else {
        ...
        value: function saveProduct() {
          ...
          if (this.addOREditProductForm.valid) {
            if (this.addOREditProductForm.dirty) {
              var product = Object.assign(Object.assign({}, this.product), this.addOREditProductForm.value);

              if (!this.editMode) {
                this.productService.addProduct(product).subscribe({
                  next: function next() {
                    _this8.addOREditProductForm.reset();

                    _this8.router.navigate(['admin/products']);
                  }
                });
              } else {
    ...
    AddOrEditProductComponent.ɵfac = function AddOrEditProductComponent_Factory(t) {
      return new (t || AddOrEditProductComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_5__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_product_service__WEBPACK_IMPORTED_MODULE_6__["ProductService"]));
    };

    AddOrEditProductComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: AddOrEditProductComponent,
      selectors: [["app-add-or-edit-product"]],
      viewQuery: function AddOrEditProductComponent_Query(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵviewQuery"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControlName"], true, _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"]);
        }
      ...
      template: function AddOrEditProductComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function AddOrEditProductComponent_Template_form_ngSubmit_5_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AddOrEditProductComponent_Template_button_click_36_listener() {
            return ctx.onCancel();
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AddOrEditProductComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  function srcAppAdminAdminRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_configs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../shared/configs */
    ...
    var _listing_products_listing_products_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./listing-products/listing-products.component */
    "./src/app/admin/listing-products/listing-products.component.ts");
    /* harmony import */


    var _add_or_edit_product_add_or_edit_product_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./add-or-edit-product/add-or-edit-product.component */
    "./src/app/admin/add-or-edit-product/add-or-edit-product.component.ts");
    /* harmony import */


    var _listing_categories_listing_categories_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./listing-categories/listing-categories.component */
    "./src/app/admin/listing-categories/listing-categories.component.ts");
    /* harmony import */


    var _add_or_edit_category_add_or_edit_category_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./add-or-edit-category/add-or-edit-category.component */
    "./src/app/admin/add-or-edit-category/add-or-edit-category.component.ts");
    /* harmony import */


    var _listing_orders_listing_orders_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./listing-orders/listing-orders.component */
    "./src/app/admin/listing-orders/listing-orders.component.ts");
    /* harmony import */


    var _order_details_order_details_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./order-details/order-details.component */
    "./src/app/admin/order-details/order-details.component.ts"); /// add the isAdminAuthorized guard before every route
    ...
    var routes = [{
      ...
      children: [{
        path: '',
        pathMatch: 'full',
        redirectTo: _shared_configs__WEBPACK_IMPORTED_MODULE_3__["CONFIG"].admin.children.productsList.route
      }, {
        path: _shared_configs__WEBPACK_IMPORTED_MODULE_3__["CONFIG"].admin.children.productsList.name,
        component: _listing_products_listing_products_component__WEBPACK_IMPORTED_MODULE_5__["ListingProductsComponent"]
      }, {
        path: _shared_configs__WEBPACK_IMPORTED_MODULE_3__["CONFIG"].admin.children.newProduct.name,
        component: _add_or_edit_product_add_or_edit_product_component__WEBPACK_IMPORTED_MODULE_6__["AddOrEditProductComponent"]
      }, {
        path: _shared_configs__WEBPACK_IMPORTED_MODULE_3__["CONFIG"].admin.children.editProduct.name,
        component: _add_or_edit_product_add_or_edit_product_component__WEBPACK_IMPORTED_MODULE_6__["AddOrEditProductComponent"]
      }, {
        path: _shared_configs__WEBPACK_IMPORTED_MODULE_3__["CONFIG"].admin.children.categoriesList.name,
        component: _listing_categories_listing_categories_component__WEBPACK_IMPORTED_MODULE_7__["ListingCategoriesComponent"]
      }, {
        path: _shared_configs__WEBPACK_IMPORTED_MODULE_3__["CONFIG"].admin.children.newCategory.name,
        component: _add_or_edit_category_add_or_edit_category_component__WEBPACK_IMPORTED_MODULE_8__["AddOrEditCategoryComponent"]
      }, {
        path: _shared_configs__WEBPACK_IMPORTED_MODULE_3__["CONFIG"].admin.children.editCategory.name,
        component: _add_or_edit_category_add_or_edit_category_component__WEBPACK_IMPORTED_MODULE_8__["AddOrEditCategoryComponent"]
      }, {
        path: _shared_configs__WEBPACK_IMPORTED_MODULE_3__["CONFIG"].admin.children.ordersList.name,
        component: _listing_orders_listing_orders_component__WEBPACK_IMPORTED_MODULE_9__["ListingOrdersComponent"]
      }, {
        path: _shared_configs__WEBPACK_IMPORTED_MODULE_3__["CONFIG"].admin.children.orderDetails.name,
        component: _order_details_order_details_component__WEBPACK_IMPORTED_MODULE_10__["OrderDetailsComponent"]
      }]
    }];
  ...
  function srcAppAdminAdminComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AdminComponent = /*#__PURE__*/function () {
      ...
      _createClass(AdminComponent, [{
        ...
        key: "toggleSubMenu",
        value: function toggleSubMenu(subMenu) {
    ...
    AdminComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 39,
      vars: 13,
      consts: [[1, "container-fluid"], [1, "row"], [1, "col-2", "p-4", "side-bar"], [1, "nav", "flex-column"], [1, "nav-item", "p-2"], [1, "nav-link", "text-light", 3, "routerLink", "click"], [1, "fa", "fa-caret-down", 3, "ngClass"], [1, "sub-link", "collapsed"], ["productsSubMenu", ""], [1, "flex-column", "pl-2", "nav"], [1, "nav-item"], [1, "nav-link", "text-light", "p-2", 3, "routerLink"], [1, "fa", "fa-plus"], [1, "fa", "fa-list-ul"], ["categoriesSubMenu", ""], [1, "nav-link", "text-light", 3, "routerLink"], [1, "col-10", "p-4"]],
      template: function AdminComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AdminComponent_Template_a_click_5_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r2);

            var _r0 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](9);

            ctx.toggleSubMenu(_r0);
            return ctx.productMenuStatus = !ctx.productMenuStatus;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AdminComponent_Template_a_click_20_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r2);

            var _r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](24);

            ctx.toggleSubMenu(_r1);
            return ctx.categoryMenuStatus = !ctx.categoryMenuStatus;
          });
  ...
  function srcAppAdminAdminModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _add_or_edit_product_add_or_edit_product_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./add-or-edit-product/add-or-edit-product.component */
    "./src/app/admin/add-or-edit-product/add-or-edit-product.component.ts");
    /* harmony import */


    var _add_or_edit_category_add_or_edit_category_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./add-or-edit-category/add-or-edit-category.component */
    "./src/app/admin/add-or-edit-category/add-or-edit-category.component.ts");
    /* harmony import */
    ...
    var _listing_products_listing_products_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./listing-products/listing-products.component */
    "./src/app/admin/listing-products/listing-products.component.ts");
    /* harmony import */


    var _listing_categories_listing_categories_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./listing-categories/listing-categories.component */
    "./src/app/admin/listing-categories/listing-categories.component.ts");
    /* harmony import */
    ...
    AdminModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _admin_routing_module__WEBPACK_IMPORTED_MODULE_4__["AdminRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["RouterModule"]]]
    });
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](AdminModule, {
        ...
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _admin_routing_module__WEBPACK_IMPORTED_MODULE_4__["AdminRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["RouterModule"]],
        exports: [_add_or_edit_product_add_or_edit_product_component__WEBPACK_IMPORTED_MODULE_2__["AddOrEditProductComponent"], _add_or_edit_category_add_or_edit_category_component__WEBPACK_IMPORTED_MODULE_3__["AddOrEditCategoryComponent"], _listing_categories_listing_categories_component__WEBPACK_IMPORTED_MODULE_8__["ListingCategoriesComponent"], _listing_products_listing_products_component__WEBPACK_IMPORTED_MODULE_7__["ListingProductsComponent"], _admin_component__WEBPACK_IMPORTED_MODULE_12__["AdminComponent"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppAdminListingCategoriesListingCategoriesComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ListingCategoriesComponent", function () {
      return ListingCategoriesComponent;
    });
    /* harmony import */
    ...
    var _c0 = function _c0(a1) {
      return ["/admin/categories", a1, "edit"];
    };

    function ListingCategoriesComponent_tr_9_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var ListingCategoriesComponent = /*#__PURE__*/function () {
      function ListingCategoriesComponent(categoryService) {
        _classCallCheck(this, ListingCategoriesComponent);

        this.categoryService = categoryService;
        this.Categories = [];
      }

      _createClass(ListingCategoriesComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this9 = this;

          this.categoryService.getCategories().subscribe({
            next: function next(categories) {
              _this9.Categories = categories;
            }
          });
        }
      }]);
    ...
    ListingCategoriesComponent.ɵfac = function ListingCategoriesComponent_Factory(t) {
      return new (t || ListingCategoriesComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_category_service__WEBPACK_IMPORTED_MODULE_1__["CategoryService"]));
    };

    ListingCategoriesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: ListingCategoriesComponent,
      selectors: [["app-listing-categories"]],
      decls: 10,
      vars: 1,
      consts: [[1, "table-responsive"], [1, "table", "table-hover", "table-striped"], ["style", "cursor: pointer;", 3, "routerLink", 4, "ngFor", "ngForOf"], [2, "cursor", "pointer", 3, "routerLink"]],
      template: function ListingCategoriesComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ListingCategoriesComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppAdminListingOrdersListingOrdersComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ListingOrdersComponent", function () {
      return ListingOrdersComponent;
    });
    /* harmony import */
    ...
    function ListingOrdersComponent_app_order_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var ListingOrdersComponent = /*#__PURE__*/function () {
      function ListingOrdersComponent(orderService, signalRService) {
        _classCallCheck(this, ListingOrdersComponent);

        this.orderService = orderService;
        this.signalRService = signalRService;
      }

      _createClass(ListingOrdersComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this10 = this;
          ...
          this.orderService.getOrders().subscribe({
            next: function next(orders) {
              return _this10.orders = orders;
            }
          });
          this.signalRService.orderReceived.subscribe(function (order) {
            _this10.orders.unshift(order);
          });
        }
      }]);
    ...
    ListingOrdersComponent.ɵfac = function ListingOrdersComponent_Factory(t) {
      return new (t || ListingOrdersComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_order_service__WEBPACK_IMPORTED_MODULE_1__["OrderService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_signal_r_service__WEBPACK_IMPORTED_MODULE_2__["SignalRService"]));
    };

    ListingOrdersComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: ListingOrdersComponent,
      selectors: [["app-listing-orders"]],
      decls: 3,
      vars: 1,
      ...
      template: function ListingOrdersComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["NgForOf"], _order_order_component__WEBPACK_IMPORTED_MODULE_4__["OrderComponent"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["RouterLink"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ListingOrdersComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppAdminListingProductsListingProductsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ListingProductsComponent", function () {
      return ListingProductsComponent;
    });
    /* harmony import */
    ...
    var _c0 = function _c0(a1) {
      return ["/admin/products", a1, "edit"];
    };

    function ListingProductsComponent_tr_14_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "tr", 3);
    ...
    var ListingProductsComponent = /*#__PURE__*/function () {
      function ListingProductsComponent(productService) {
        _classCallCheck(this, ListingProductsComponent);

        this.productService = productService;
        this.products = [];
      }

      _createClass(ListingProductsComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this11 = this;
    ...
    ListingProductsComponent.ɵfac = function ListingProductsComponent_Factory(t) {
      return new (t || ListingProductsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_product_service__WEBPACK_IMPORTED_MODULE_1__["ProductService"]));
    };

    ListingProductsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: ListingProductsComponent,
      selectors: [["app-listing-products"]],
      decls: 15,
      vars: 1,
      consts: [[1, "table-responsive"], [1, "table", "table-hover", "table-striped"], ["style", "cursor: pointer;", 3, "routerLink", 4, "ngFor", "ngForOf"], [2, "cursor", "pointer", 3, "routerLink"]],
      template: function ListingProductsComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ListingProductsComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppAdminOrderOrderComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    OrderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 9,
      vars: 1,
      consts: [[1, "order"], [1, "card", "border-success", "text-center"], [1, "card-body", "text-success"], [1, "card-text"], [1, "text-center", "text-black-50"], [1, "fa", "fa-chevron-right", "font-sm", "font-weight-light"]],
